...
#     # Exibe a mensagem triste apenas se `counter` for múltiplo de 2 após atingir 2
#     if counter > 2 and counter % 2 == 1:
#         print(":( Sad face! You've been here too many times.")
...
# 	if letter == 'e':
# 		counter += 1
# print(f'The letter is in the string {counter} times') # print(counter)
